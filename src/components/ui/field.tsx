...
function FieldDescription({ className, ...props }: React.ComponentProps<'p'>) {
    return (
        <p
            className={cn(
                `
                  text-sm leading-normal font-normal text-neutral-500
                  group-has-data-[orientation=horizontal]/field:text-balance
                `,
                'last:mt-0 nth-last-2:-mt-1 [[data-variant=legend]+&]:-mt-1.5',
                '[&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-neutral-800',
                className,
            )}
        ...
        <Label
            className={cn(
                ...
                `
                  ...
                  *:data-[slot=field]:p-4
                `,
                `has-data-[state=checked]:border-neutral-800 has-data-[state=checked]:bg-neutral-800/5`,
                className,
            )}
...
function FieldSeparator({
    ...
    return (
        ...
        >
            ...
            {children && (
                <span
                    className={`relative mx-auto block w-fit bg-white px-2 text-neutral-500`}
