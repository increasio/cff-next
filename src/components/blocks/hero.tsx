...
export function Hero() {
    ...
    return (
        <section className="relative">
            ...
            <div className="relative z-10 container mx-auto flex gap-[77px] pt-20 pb-28">
                <div className="flex shrink-0 flex-col items-start gap-[72px]">
                    <div className="flex max-w-[431px] flex-col gap-5">
                        <h1 className="text-[40px] leading-[120%] font-bold text-balance">
                            Cash Flow Frog — The Best Cash Flow Forecasting Software
                        </h1>
                        <p className="text-xl leading-[160%] text-text">
                ...
                <div
                    ...
                    `}
                >
                    <div className={`shadow-custom aspect-video w-full rounded-xl bg-white p-5`} />
                </div>
            </div>
        </section>
    )
